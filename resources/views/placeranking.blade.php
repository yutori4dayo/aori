...
<div id="myTabContent" class="tab-content">
  ...
  <div id="region" class="tab-pane" role="tabpanel" aria-labelledby="region-tab">
    <ul>
      <li class="d-flex RankingList"><img src="{{  asset('img/f3-1.png') }}" alt="" class="top3">　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[0])  }}">{{$region[0]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[0]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><img src="{{  asset('img/f3-2.png') }}" alt="" class="top3">　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[1])  }}">{{$region[1]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[1]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><img src="{{  asset('img/f3-3.png') }}" alt="" class="top3">　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[2])  }}">{{$region[2]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[2]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">4位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[3])  }}">{{$region[3]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[3]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">5位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[4])  }}">{{$region[4]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[4]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">6位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[5])  }}">{{$region[5]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[5]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">7位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[6])  }}">{{$region[6]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[6]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">8位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[7])  }}">{{$region[7]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[7]}}件
          </div>
        </div>
      ...
      <li class="d-flex RankingList"><span class="under">9位</span>　
        <div class="PreCountBox">
          <a href="{{ action('RegionListController@getRegion', $code[8])  }}">{{$region[8]}}{{'ナンバー'}}　</a>
          <div class="RankingCount">
            {{$regioncount[8]}}件
          </div>
        </div>
